...
data1 = fscanf(fd1, "%f%*[,;]", [size, 3*size]);    %读取数组
data2 = fscanf(fd2, "%f%*[,;]", [size, 3*size]);
data3 = fscanf(fd3, "%f%*[,;]", [size, 3*size]);
data4 = fscanf(fd4, "%f%*[,;]", [size, 3*size]);
...
weight1 = fscanf(fw1, "%f%*[,;]", [3, 9]);
weight2 = fscanf(fw2, "%f%*[,;]", [3, 9]);
weight3 = fscanf(fw3, "%f%*[,;]", [3, 9]);
weight4 = fscanf(fw4, "%f%*[,;]", [3, 9]);
...
result_out = fscanf(fr, "%f%*[,;]", [size, size]);
...
outcome = abs(result_expected - result_out) < 0.0001;
